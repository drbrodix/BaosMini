//#include "../../include/Services/TestBaosComm.hpp"
//
//TestBaosComm::TestBaosComm(
//	unsigned short dpId,
...
//}
//
//inline void TestBaosComm::initTelegram()
//{
...
//}
//
//bool TestBaosComm::checkForError()
//{
...
//
//template <typename T>
//bool TestBaosComm::setValue(T dpValue, DatapointTypes::DATAPOINT_TYPES dpt, CommandByte commandByte, bool decode)
//{
...
//}
//
//bool TestBaosComm::setBoolean(bool dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<bool>(dpValue, DatapointTypes::BOOLEAN, commandByte, decode);
//}
//
//bool TestBaosComm::setUnsignedValue1Byte(unsigned char dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<unsigned char>(dpValue, DatapointTypes::UNSIGNED_VALUE_1BYTE, commandByte, decode);
//}
//
//bool TestBaosComm::setSignedValue1Byte(signed char dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<signed char>(dpValue, DatapointTypes::SIGNED_VALUE_1BYTE, commandByte, decode);
//}
//
//bool TestBaosComm::setUnsignedValue2Byte(unsigned short dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<unsigned short>(swap2(dpValue), DatapointTypes::UNSIGNED_VALUE_2BYTE, commandByte, decode);
//}
//
//bool TestBaosComm::setSignedValue2Byte(signed short dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<signed short>(swap2(dpValue), DatapointTypes::SIGNED_VALUE_2BYTE, commandByte, decode);
//}
//
//bool TestBaosComm::setUnsignedValue4Byte(unsigned int dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<unsigned int>(swap4(dpValue), DatapointTypes::UNSIGNED_VALUE_4BYTE, commandByte, decode);
//}
//
//bool TestBaosComm::setSignedValue4Byte(signed int dpValue, CommandByte commandByte, bool decode)
//{
//	return setValue<signed int>(swap4(dpValue), DatapointTypes::SIGNED_VALUE_4BYTE, commandByte, decode);
//}
//
//bool TestBaosComm::setFloatValue2Byte(float dpValue, CommandByte commandByte, bool decode)
//{
...
//}
//
//bool TestBaosComm::setFloatValue4Byte(float dpValue, CommandByte commandByte, bool decode)
//{
